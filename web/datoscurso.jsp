        ...
        <%        
                ...
                while (rs.next()) {    
                    ...
                    <tr>
                        ...
                        <td><a href="datoscurso.jsp?f_accion=E&f_idcurso=<%out.print(ide);%>"><input type=image src="img/delete.png" width="40" height="30"></a></td>
                        <td><a href="datoscurso.jsp?f_accion=M1&f_idcurso=<%out.print(ide);%>"><input type=image src="img/edit.png" width="40" height="30"></a></td>
